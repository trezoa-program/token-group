...
use {
    ...
    tpl_discriminator::{ArrayDiscriminator, SplDiscriminate},
    tpl_pod::{
...
#[discriminator_hash_input("tpl_token_group_interface:initialize_token_group")]
...
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable, SplDiscriminate)]
#[discriminator_hash_input("tpl_token_group_interface:update_group_max_size")]
...
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable, SplDiscriminate)]
#[discriminator_hash_input("tpl_token_group_interface:update_authority")]
...
#[repr(C)]
#[derive(Clone, Copy, Debug, PartialEq, Pod, Zeroable, SplDiscriminate)]
#[discriminator_hash_input("tpl_token_group_interface:initialize_member")]
pub struct InitializeMember;

/// All instructions that must be implemented in the TPL Token Group Interface
...
#[cfg(test)]
mod test {
    use {super::*, crate::NAMESPACE, trezoa_sha256_hasher::hashv};
