...
import type { Decoder } from '@trezoa/codecs';
import { fixDecoderSize, getBytesDecoder, getStructDecoder, getU64Decoder } from '@trezoa/codecs';
import { tplDiscriminate } from '@trezoa/tpl-type-length-value';
import { PublicKey, type TransactionInstruction } from '@trezoa/web3.js';
...
describe('Token Group Instructions', () => {
    ...
    it('Can create InitializeGroup Instruction', async () => {
        checkPackUnpack(
            ...
            await tplDiscriminate('tpl_token_group_interface:initialize_token_group'),
            getStructDecoder([
    ...
    it('Can create UpdateGroupMaxSize Instruction', async () => {
        checkPackUnpack(
            ...
            await tplDiscriminate('tpl_token_group_interface:update_group_max_size'),
    ...
    it('Can create UpdateGroupAuthority Instruction', async () => {
        checkPackUnpack(
            ...
            await tplDiscriminate('tpl_token_group_interface:update_authority'),
    ...
    it('Can create InitializeMember Instruction', async () => {
        ...
        checkPackUnpack(
            ...
            await tplDiscriminate('tpl_token_group_interface:initialize_member'),
            getStructDecoder([]),
            {},
        );
    });
