use {
    trezoa_program_test::{processor, tokio::sync::Mutex, ProgramTest, ProgramTestContext},
...
pub async fn setup_program_test(
    ...
    let mut program_test = ProgramTest::new(
        "tpl_token_group_example",
        *program_id,
        processor!(tpl_token_group_example::processor::process),
    );
    program_test.prefer_bpf(false);
    program_test.add_program(
        "tpl_token_2022",
        tpl_token_2022::id(),
        processor!(tpl_token_2022::processor::Processor::process),
    );
